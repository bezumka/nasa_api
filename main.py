...
sys.path.append('/home/nasa_api')

from configs.config import PATH_TO_HTML_REPORT, PATH_TO_HOME_DIR
...
def run_test_in_multiple_module_file_generate_html_report():
    ...
    all_test_cases = unittest.defaultTestLoader.discover(PATH_TO_HOME_DIR + 'tests', 'test_*.py')
